...
1.3.
Итоги главы :
Мы выбрали цельь - создание работающего сайта в WEB, определились с инструментарием WORPDPRESS с использованием локального сервера MAMP. Произвели необходимую установку серверов и стартовый запуск WORLDPRESS, убедились в работоспособности системы.
