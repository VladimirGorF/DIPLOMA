...
2.2.5 Меню для footer и page.
Теперь зарегистрируем еще 2 меню(а точнее области видимости) в нашей функции function theme_register_nav_menu() добавим еще две строчки в файле functions.php:

register_nav_menu( 'footer', 'Меню в подвале' );

register_nav_menu( 'page_menu_top', 'Меню в страничке page' );

И затем в footer.php добавим: 
...
Заведем меню в админке WP. Внешний вид\ Меню \Создать новое меню. Назовем его 'Меню в подвале'  и установим область отображения 'Меню в подвале'. Нажимаем создать меню. Далее добавим еще несколько страниц в наше меню. 
После этого к меню применятся нужные стили и оно выстроится в строчку, как и нужно.
...
Теперь займемся меню для нащих страничек и в header-page.php добавим:  
...
<?php get_header('page'); ?>.
Разница с обычным вызывом в том, что мы передаем в в функцию вызова аргумент, идентифицирующий тот header, который нам нужен, а именно header-page.php. WP сам понимает по второй части названия файла, что он относится к нужному нам header.

Теперь проверяем меню на странице контакты и видим что в ней у нас появилось отдельное меню отличное от нашего на главной странице сайта.
...
2.2.6 Произвольные ссылки.
Теперь попробуем добавить произвольные ссылки в наше подвальное меню. Для этого в меню WP заходим Внешний вид\Меню. Находим там поле 'Выберите меню для изменения:'. Выбираем меню в подвале. Жмем кнопочку 'Выбрать'. Слева в разделе 'Добавьте элементы меню' внизу есть 'Произвольные ссылки'. Создадим две произвольные сслыки: Гик-Брейнс и Яндекс. Жмем 'Добавить в меню' и 'сохранить Меню'. 
<img width="1728" alt="Снимок экрана 2023-08-24 в 09 33 44" src="https://github.com/VladimirGorF/DIPLOMA/assets/110591063/2bcc471b-4f9f-44f9-892d-9bf6bedf9ef9">

Они будут отражаться в нашем подвальном меню наравне со страницами этого меню и кликнув по этим ссылкам вы попадете на стартовый страница Гик-Бренс или Яндекс соответсвенно.  
<img width="1728" alt="Снимок экрана 2023-08-24 в 09 34 41" src="https://github.com/VladimirGorF/DIPLOMA/assets/110591063/4c4509d5-db4d-46b2-a53d-1ade4a3051d5">

2.2.7 Якорные ссылки.
Теперь добавим якорные ссылки в наше верхнее меню на главной странице. Для этого в меню WP заходим Внешний вид\Меню. Находим там поле 'Выберите меню для изменения:'. Выбираем верхнее меню. Жмем кнопочку 'Выбрать'. Слева в разделе 'Добавьте элементы меню' внизу есть 'Произвольные ссылки'. В URL пишем #footer (это и есть наша якорная ссылка). В тексте ссылки пишем 'Подвал'. Добавляем в меню. Затем превращаем эту ссылку в дочернюю страницу Главной.

<img width="1728" alt="Снимок экрана 2023-08-24 в 09 55 58" src="https://github.com/VladimirGorF/DIPLOMA/assets/110591063/7eefb7f5-946c-4ea5-8aea-b0aa86f820e8">

Теперь в нашем файле footer.php  в тег footer нужно установить идентификатор. 
<footer id="footer"> 
Все готово. Теперь, по якорной сссылке из нашего верхнего меню на главной странице можно сразу же перейти в подвал.
<img width="1728" alt="Снимок экрана 2023-08-24 в 10 01 33" src="https://github.com/VladimirGorF/DIPLOMA/assets/110591063/13bf5852-36e4-42d5-858d-ad280fc07afb">
