...
Далее создадим функцию для регистраци собственного типа Portfolio. Установим 'menu_position'  => 4 , очередность вывода типа.  И немного расширим 'supports'  => [ 'title', 'editor','author','thumbnail', 'excerpt' ], чтобы изспользовать возможности 'thumbnail' и 'excerpt'(частичное вопроизведение).
